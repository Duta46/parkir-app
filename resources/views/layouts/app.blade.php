...
<html
  ...
  <head>
    ...
    {{-- FontAwesome --}}
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLMD/CDQeB9i5vT2/Qx8F7E41R/t3N4h1F355xL5J8H2XQvU1hQvFqR6uP6aA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu">
          <div class="app-brand demo">
            <a href="/" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-3">{{ config('app.name', 'Parkir') }}</span>
            </a>
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                              ...
                              <small class="mb-1 d-block text-body">Welcome to {{ config('app.name') }}</small>
                    ...
                    <li>
                      <a class="dropdown-item mt-0" href="javascript:void(0);">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="flex-grow-1">
                            <h6 class="mb-0">@auth {{ Auth::user()->name }} @else Guest @endauth</h6>
                            <small class="text-body-secondary">@auth {{ Auth::user()->email }} @else User @endauth</small>
                          </div>
                        </div>
                      </a>
                    </li>
